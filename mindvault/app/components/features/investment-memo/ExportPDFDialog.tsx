                ...
                <div>
                  <div className="grid grid-cols-3 gap-2">
                    <button 
                      ...
                      onClick={() => onOptionsChange({ ...options, language: 'en' })}
                    >
                      English
                    </button>
                    <button 
                      className="px-4 py-3 rounded-lg font-medium relative bg-gray-100 text-gray-400 cursor-not-allowed"
                      disabled
                    >
                      日本語
                      <span className="absolute -top-1 -right-1 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white bg-gray-400 rounded-full">
                        Soon
                      </span>
                    </button>
                  </div>
